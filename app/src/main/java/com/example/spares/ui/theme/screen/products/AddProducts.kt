        ...
        Box {
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = {
                        Text(
                            text = "Vehicle name/Spare part name e.g Honda CRV / Suspensions",
                            color = Color.Yellow
                        )
                    },
                ...
                OutlinedTextField(
                    ...
                    label = { Text(text = "Number of spares", color = Color.Yellow) },
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
                )
                ...
                OutlinedTextField(
                    ...
                    label = { Text(text = "Price in KES", color = Color.Yellow) },
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
                )
